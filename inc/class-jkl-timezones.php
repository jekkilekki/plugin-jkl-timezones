...
if ( ! class_exists( 'JKL_Timezones' ) ) {
    ...
    class JKL_Timezones {
        ...
        public function jkl_tz_scripts_styles() {
            ...
            global $post;
            if( is_active_widget( false, false, 'jkl_timezones_widget' ) 
                    || has_shortcode( $post->post_content, 'jkltz' ) 
                    || has_shortcode( $post->post_content, 'jkl-timezone') 
                    || has_shortcode( $post->post_content, 'jkl-timezones' ) ) {
